  ...
  while (current) {
    ...
    while (route.name in currentOptions && hasNext) {
      ...
      if (route.params) {
        ...
        const currentParams = Object.fromEntries(Object.entries(route.params).map(_ref => {
          let [key, value] = _ref;
...
const createNormalizedConfigs = (options, pattern) => Object.fromEntries(Object.entries(options).map(_ref2 => {
  let [name, c] = _ref2;
